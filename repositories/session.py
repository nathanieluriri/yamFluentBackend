...
# SESSION REPOSITORY
# ============================================================================
# This file was auto-generated on: 2026-01-05 17:43:20 WAT
...
async def update_session(filter_dict: dict, session_data: SessionUpdate) -> SessionOut:
    ...
    # Pull out script.turns updates to avoid overwriting the entire array
    script = payload.pop("script", None)
    turns_updates = None
    if script:
        turns_updates = script.pop("turns", None)

        # other script fields (if any)
    ...
    # apply turn updates by index, but only for role == "user"
    if turns_updates:
